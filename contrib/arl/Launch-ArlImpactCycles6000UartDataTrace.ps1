...
$uartData = Join-Path $root "Launch-ArlImpactUartDataTrace.ps1"
if (-not (Test-Path -Path $uartData -PathType Leaf)) {
    throw "Launch-ArlImpactUartDataTrace.ps1 not found below $root"
}
