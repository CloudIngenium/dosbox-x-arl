...
# operator desktop is now built and undone by Set-ArlOperatorDesktop.ps1, which lays down four
# public shortcuts (three Spanish launchers plus the Ayuda guide card) and the admin-only
# diagnostics groups under one manifest; see docs/ARL-OPERATOR-DESKTOP.md. The
